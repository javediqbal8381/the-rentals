...
function BookingCar({ match }) {
  ...
  return (
    <>
    {loading?(<Spinner name='Booking Car'/>):(
      <DefaultLayout>
      <Row justify='center' className='d-flex align-items-center' style={{ minHeight: '90vh' }}>
        ...
        <Col lg={10} sm={24} xs={24}>
          ...
          <div className='bookingcar-divider-2nd-div'>
            ...
            <p>{car.rentperHour} Rent Per Hour {car.rentPerHour} /-</p>
          </div>
          <Divider type='horizental' dashed >Select Time Range</Divider>
          <RangePicker showTime='HH:mm' format='YYYY-MM-DD HH:mm' onChange={selectTimeSlots} />
          <br />
          <button className='btn1 mt-2 seebookedslots' onClick={() => { setShowModal(true) }}>Booked Slots</button>
