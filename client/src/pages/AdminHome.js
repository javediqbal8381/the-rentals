            ...
            return <Col lg={5} sm={24} xs={24}>
              <div className='car p-2 bs1 '> 
                ...
                <div className='car-content d-flex align-items-center justify-content-between'>
                  ...
                  <div>
                    <Link to={`/editcar/${car._id}`}> <EditOutlined className='mr-2 adminsvgicons' style={{ color: 'blue', cursor: 'pointer' }} /></Link>
                    <Popconfirm
                      ...
                      cancelText="No"
                    >
                      <DeleteOutlined className=' adminsvgicons' style={{ color: 'red', cursor: 'pointer' }} />
                    </Popconfirm>
                  </div>
                </div>
              </div>
